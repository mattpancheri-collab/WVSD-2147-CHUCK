...
public final class Constants {
    ...
    public static final class LauncherConstants {
        ...
        /** Maximum safe speed for flywheels (Rotations Per Second). Range: 0-90. */
        public static final double kShooterMaxRPS = 85.0;
        /** Speed used when "idling" the launcher (Rotations Per Second) */
        public static final double kShooterIdleRPS = 10.0;
        /** Speed for a close-range shot (Rotations Per Second) */
        public static final double kShooterCloseRPS = 45.0;
        /** Speed for a far-range shot (Rotations Per Second) */
        ...
        /** Whether to enable stator current limiting for the shooter leader */
        public static final boolean kShooterEnableStatorLimit = true;
        /** Stator current limit for flywheels (Amps). Range: 40-100. */
        ...
        /** Gear ratio of the hood mechanism (motor:mechanism). */
        public static final double kHoodGearRatio = 36.57;

        // Hood Current Limiting
        /** Whether to enable stator current limiting for the hood Kraken X44 */
        public static final boolean kHoodEnableStatorLimit = true;
        /** Stator current limit for hood (Amps). Range: 20-60. */
    ...
    public static final class LaunchFeederConstants {
        ...
        // Speed Presets (RPS)
        /** Maximum safe speed for feeder (Rotations Per Second) */
        public static final double kMaxRPS = 80.0;
        /** Speed for feeding balls "in" to the launcher (Rotations Per Second) */
        public static final double kFeedInRPS = 40.0;
        /** Speed for spitting balls "out" (Rotations Per Second) */
        ...
        /**
         * Time (seconds) the ball must be detected before acting. Prevents false
         * triggers.
         */
        public static final double kBallDebounceSeconds = 0.05;

        /** Whether the feeder should automatically stop when a ball is detected */
        public static final boolean kAutoStopOnBall = true;

        // Current Limiting
        /** Whether to enable stator current limiting for the feeder TalonFX */
        public static final boolean kEnableStatorLimit = true;
        /** Stator current limit for feeder (Amps). Range: 40-70. */
    ...
    public static final class FloorFeederConstants {
        ...
        // Speed Presets (RPS)
        /** Maximum safe speed for floor feeder (Rotations Per Second) */
        public static final double kMaxRPS = 80.0;
        /** Speed for moving balls forward (Rotations Per Second) */
        public static final double kFeedInRPS = 40.0;
        /** Speed for clearing jams (Rotations Per Second) */
        public static final double kFeedOutRPS = -20.0;
        /** 📉 How fast the floor feeder motor ramps (RPS per second) */
        public static final double kRampRPSPerSec = 200.0;

        // Current Limiting
        /** Whether to enable stator current limiting for the TalonFX */
        public static final boolean kEnableStatorLimit = true;
        /** Stator current limit for floor feeder (Amps). Range: 40-70. */
        public static final double kStatorLimitAmps = 60.0;
    }
    ...
    public static final class IntakePivotConstants {
        ...
        /**
         * Gear ratio of the pivot (Intake rotates once for every 50 motor rotations)
         */
        public static final double kGearRatio = 50.0;

        // Current Limiting
        /** Whether to enable stator current limiting for the Kraken */
        public static final boolean kEnableStatorLimit = true;
        /** Stator current limit for the pivot (Amps). Range: 20-50. */
        public static final double kStatorLimitAmps = 40.0;

        // Velocity Limit for manual control (RPS)
        /**
         * Maximum rotation speed for the pivot mechanism (RPS). Keep low for
         * safety.
         */
    ...
    public static final class IntakeFloorConstants {
        ...
        // Speed Presets (RPS)
        /** Maximum safe speed for intake rollers (Rotations Per Second) */
        public static final double kMaxRPS = 80.0;
        /** Speed for active intaking (Rotations Per Second) */
        public static final double kIntakeInRPS = 60.0;
        /** Speed for ejecting game pieces (Rotations Per Second) */
        ...
        /** Whether to enable stator current limiting for the TalonFX */
        public static final boolean kEnableStatorLimit = true;
        /** Stator current limit for intake (Amps). Range: 40-70. */
        public static final double kStatorLimitAmps = 60.0;
    }
    ...
    public static final class ClimberConstants {
        ...
        /** Whether to enable stator current limiting for the TalonFX */
        public static final boolean kEnableStatorLimit = true;
        /** Stator current limit for climber (Amps). Range: 40-100. */
